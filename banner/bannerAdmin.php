        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="insertRegister.php?g=checkName" method="post">
                    <div>
                        <label for=""
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">รหัสประจำตัว</label>
                        <input type="text" name="idCode" id=""
                    ...
                    <button type="submit"
                        class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">เข้าสู่ระบบ</button>
                    <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                        ลงทะเบียนเข้าใช้งาน ? <a href="register.php"
                            class="text-blue-700 hover:underline dark:text-blue-500">ลงทะเบียน</a>
                    </div>
                </form>
            </div>
        </div>
