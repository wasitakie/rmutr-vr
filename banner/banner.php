    ...
    <div class="banner">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="./about.php">รายชื่อผู้สมัคร</a></li>
                <li><a href="./contact.php">ส่งผลวิ่ง</a></li>
                <li><a href="./login.php">รายงานผล</a></li>
                <li><a href="./logout.php">สรุปผล</a></li>

            </ul>

        </div>
        <div class="btn">
            <button type="button" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">ลงชื่อเข้าใช้ / ลงทะเบียน</button>
        </div>
